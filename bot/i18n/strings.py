...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "schema_unavailable": {
        ...
        "sw": "⚠️ Muundo wa fomu haukuweza kupakiwa — fomu rahisi itatumika. Maswali fulani yanaweza kukosekana.",
    },
    "field_skip": {
        ...
        "sw": "Swali hili si la lazima — bonyeza Ruka ili kuendelea bila kujibu.",
    },
    "field_select_min_one": {
        ...
        "sw": "Tafadhali chagua chaguo moja angalau kabla ya kuendelea.",
    },
    "field_required": {
        ...
        "sw": "Uga huu unahitajika — tafadhali fanya chaguo.",
    },
    "field_invalid_number": {
        ...
        "sw": "Tafadhali ingiza nambari sahihi.",
    },
    "error_generic": {
